...
def main() :
    ...
    parser.add_argument('-i1', '--image1', type = str, default = str(Path(__file__).parent/'grid1.jpg'),
                        help = 'filename of input image 1')
    parser.add_argument('-c1', '--cam1', type = str, default = str(Path(__file__).parent/'grid1.cam'),
                        help = 'filename of camera calibration output 1')
    parser.add_argument('-i2', '--image2', type = str, default = str(Path(__file__).parent/'grid2.jpg'),
                        help = 'filename of input image 2')
    parser.add_argument('-c2', '--cam2', type = str, default = str(Path(__file__).parent/'grid2.cam'),
